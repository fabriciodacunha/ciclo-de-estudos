package com.cuoli.ciclodeestudos.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.cuoli.ciclodeestudos.service.EmailAlreadyUsedException ||
            ex instanceof com.cuoli.ciclodeestudos.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.cuoli.ciclodeestudos.service.InvalidPasswordException
